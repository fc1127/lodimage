...
-(void)loadviewvc{
    _showTakePhotoBtnSwitch=[[UISwitch alloc]initWithFrame:CGRectMake(200, 50, 100, 50)];
    _allowPickingImageSwitch=[[UISwitch alloc]initWithFrame:CGRectMake(200, 230, 100, 50)];
    _allowPickingImageSwitch.on=YES;
    _showTakePhotoBtnSwitch.on=YES;
//        _sortAscendingSwitch=[[UISwitch alloc]initWithFrame:CGRectMake(200, 110, 100, 50)];
//        _allowPickingVideoSwitch=[[UISwitch alloc]initWithFrame:CGRectMake(200, 170, 100, 50)];
//    _allowPickingOriginalPhotoSwitch=[[UISwitch alloc]initWithFrame:CGRectMake(200, 290, 100, 50)];
//    _showSheetSwitch=[[UISwitch alloc]initWithFrame:CGRectMake(200, 350, 100, 50)];
    _maxCountTF=[[UITextField alloc]initWithFrame:CGRectMake(50, 200, 100, 50)];
    _columnNumberTF=[[UITextField alloc]initWithFrame:CGRectMake(50, 260, 100, 50)];
    _maxCountTF.borderStyle=UITextBorderStyleLine;
    _columnNumberTF.borderStyle=UITextBorderStyleLine;
    _maxCountTF.text=@"10";
    _columnNumberTF.text=@"3";
...
//        return;
//    }
    TZImagePickerController *imagePickerVc = [[TZImagePickerController alloc] initWithMaxImagesCount:5 columnNumber:3 delegate:self pushPhotoPickerVc:YES];
